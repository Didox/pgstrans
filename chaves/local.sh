...
## A chave privada
private_key=/Users/danilo/projetos/rosi/pgstrans/chaves/rsapagasoprivkey.pem
public_key=/Users/danilo/projetos/rosi/pgstrans/chaves/spgw_public.der
...
########### erro ao rodar | base64 -d | no MAC descobrir ###########
