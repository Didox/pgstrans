...
namespace CriptoPagasoLoop
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var MSISDN = Environment.GetEnvironmentVariable("MSISDN");

            Console.WriteLine(string.Format("PWD dinamica: {0}", Encryption.HashHMACHex(agentKey, requestID + userId + MSISDN)));
        }
    }
}
