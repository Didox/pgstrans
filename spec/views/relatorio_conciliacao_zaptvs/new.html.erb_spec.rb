...
RSpec.describe "relatorio_conciliacao_zaptvs/new", type: :view do
  before(:each) do
    assign(:relatorio_conciliacao_zaptv, RelatorioConciliacaoZaptv.new(
      :partner => nil,
      :url => "MyString",
  ...
  it "renders new relatorio_conciliacao_zaptv form" do
    render

    assert_select "form[action=?][method=?]", relatorio_conciliacao_zaptvs_path, "post" do
