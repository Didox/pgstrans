...
RSpec.describe "pagamentos_faturas_dstvs/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit pagamentos_faturas_dstv form" do
    render

    assert_select "form[action=?][method=?]", pagamentos_faturas_dstv_path(@pagamentos_faturas_dstv), "post" do
