...
RSpec.describe "email_historico_envios/new", type: :view do
  before(:each) do
    assign(:email_historico_envio, EmailHistoricoEnvio.new(
      email: "MyString",
      titulo: "MyString",
      conteudo: "MyText",
      usuario: nil,
  ...
  it "renders new email_historico_envio form" do
    render

    assert_select "form[action=?][method=?]", email_historico_envios_path, "post" do
