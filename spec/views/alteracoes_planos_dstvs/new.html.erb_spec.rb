...
RSpec.describe "alteracoes_planos_dstvs/new", type: :view do
  before(:each) do
    assign(:alteracoes_planos_dstv, AlteracoesPlanosDstv.new(
      :request_body => "MyText",
  ...
  it "renders new alteracoes_planos_dstv form" do
    render

    assert_select "form[action=?][method=?]", alteracoes_planos_dstvs_path, "post" do
