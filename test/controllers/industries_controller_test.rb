...
class IndustriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create industry" do
    assert_difference('Industry.count') do
      post industries_url, params: { industry: { descr_curta: @industry.descr_curta, descr_longa: @industry.descr_longa } }
    end
  ...
  test "should update industry" do
    patch industry_url(@industry), params: { industry: { descr_curta: @industry.descr_curta, descr_longa: @industry.descr_longa } }
