class StatusProdutosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @status_produto.save
        format.html { redirect_to @status_produto, notice: 'Status produto was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @status_produto.update(status_produto_params)
        format.html { redirect_to @status_produto, notice: 'Status produto was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to status_produtos_url, notice: 'Status produto was successfully destroyed.' }
