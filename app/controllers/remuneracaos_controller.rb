class RemuneracaosController < ApplicationController
  ...
  private
    ...
    def remuneracao_params
      params.require(:remuneracao).permit(:nome, :usuario_id, :produto_id, :valor_venda_final_telemovel, :valor_venda_final_site, :valor_venda_final_pos, :valor_venda_final_tef, :vigencia_inicio, :vigencia_fim)
    end
end
