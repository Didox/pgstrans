...
curl -I -H "Content-Type: application/json"  -H "Authorization: Basic UGFnYVNPQWRtaW46MjAyMlBAR0BTMFQzQ2g=" -H "otp: qkjxlWKSzo4cEnd" -X GET http://10.250.80.74:9214/HTTP_ValidateOTP/
...
curl -X POST http://10.250.80.74:9214/HTTP_Recharge/ -d '{"ProductCode":"00", "ParameterCode":"00", "Amount":"10", "TargetMSISDN":"244959560801", "TransactionReference":"111111"}' -H "Content-Type: application/json" -H "Authorization: Bearer eyJMb2dpbiI6IlBhZ2FTT0FkbWluIiwiVG9rZW5UeXBlIjoiUmVmcmVzaCIsImFsZyI6IlBTNTEyIiwidHlwIjoiSldTIn0..FrRFQEGLj398Jpel4bvbONg22qO2d3RjXA7A7k7vzt-I3mpErrZXX6_JQaCu_VfYz-L8IJpAt2V3-Ck9QP6UEB6FrrLFwYUmk8eR5uNCHEIpZ8B9kDIz2f_kerIzQWZPnnghOhOQ8phpfD47YRvBaUGGpdELBYQP7FmECI0syhT-6HcnxDfWCTfaDm565ZNeW4ast-uWz-SPuoxDLD9KmUsbuCIsRwzr3BBvkChhXiI0Ak-xiXHHZ4rj4sz55H8DCfBv3lMuB868OycaAqIjkOagdxFKpkuDnAjewJlVP4fgp6S4u541-mbF65Xc8TcjoiLTKeETK4qPanKxxADrpg" 
