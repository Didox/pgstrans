...
curl -I -H "Content-Type: application/json"  -H "Authorization: Basic UGFnYVNPQWRtaW46MjAyMlBAR0BTMFQzQ2g=" -H "otp: 2Gjx9flOVOTje7w" -X GET http://10.250.80.74:9214/HTTP_ValidateOTP/
