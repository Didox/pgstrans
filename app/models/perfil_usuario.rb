class PerfilUsuario < ApplicationRecord
  ...
  def self.action_amigavel(action)
    nomes = {
      ...
      produtos_zap_api: "Lista de produtos da ZAP TV WIFI pela Pagasó API",
  ...
  def self.nome_amigavel_controller(controller)
    nomes = {
      ...
      usuario_referencia_pagamentos: "Registro de ações sobre Pagamento por Referência (Geração e Exclusão)"
    }
